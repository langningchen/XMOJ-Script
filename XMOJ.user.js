        ...
        if (UtilityEnabled("NewBootstrap")) {
          document.querySelector(
            "#simform"
                    ...
                    <input class="form-control" type="text" size="4" name="user_id" value="${
    ...
    <center class="mt-3">
      ...
      for (let i = 0; i < Temp.length; i++) {
        if (Temp[i].children[5].children[0] != null) {
          Temp[i].children[1].innerHTML = `<a href="${
            Temp[i].children[5].children[0].href +
            `">` +
      ...
      if (CurrentPage != 1) {
        Pagination += `<li class="page-item"><a href="problemstatus.php?id=${
          PID +
      ...
      Pagination += `<li class="active page-item"><a href="problemstatus.php?id=${
        PID + `&page=` + CurrentPage + `" class="page-link">` + CurrentPage
      }</a></li>`;
      if (
          ...
          RequestAPI("GetMailList", {}, (ResponseData) => {
            if (ResponseData.Success) {
              ...
              for (let i = 0; i < Data.length; i++) {
                ...
                ReceiveTable.children[1].appendChild(Row);
                Row.innerHTML =
                  `<td><a href="mail.php?other=${
                    Data[i].OtherUser + `">` + Data[i].OtherUser
                  }</a>` +
      ...
      if (UtilityEnabled("Discussion")) {
        ...
        if (location.pathname == "/discuss3/discuss.php") {
          ...
          document.querySelector("body > div > div").innerHTML = `<h3>讨论列表${
